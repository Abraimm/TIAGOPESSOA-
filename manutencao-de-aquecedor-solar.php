  ...
  <main id="main">
    ...
    <section id="sobre" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4">
          <div class="col-lg-6">
            <h2 style='color:#4D8232!important;font-size:40px!important;font-weight:bold!important'>Manutenção de Aquecedor Solar</h2>
			<hr>
			<br>
            <p style='color: #595959!important;font-weight: 500!important;text-align:justify!important;font-size:24px!important'>
			Realizamos Manutenção de Aquecedor Solar de alta qualidade.
			<bR>
			<bR>
			Realizamos serviços de manutenção, limpeza e Manutenção de Aquecedor Solar.
			<bR>
			<bR>
			Contamos com profissionais treinados.
			<bR>
			<bR>
          ...
          <div class="col-lg-6">
			...
			<br>
			<img src="assets/img/manutencao-de-aquecedor-solar.jpg" class="img-fluid rounded-4" alt="">
