  ...
  <main id="main">
    ...
    <section id="sobre" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4">
          <div class="col-lg-6">
            <h2 style='color:#4D8232!important;font-size:40px!important;font-weight:bold!important'>Garantia de inversores</h2>
			<hr>
			<br>
            <p style='color: #595959!important;font-weight: 500!important;text-align:justify!important;font-size:24px!important'>
			Se a empresa que prestou o serviço da instalação das placas solares e por algum motivo o seu inversor deu problema e a empresa não te dá suporte. 
			<br>
			Oferecemos nosso serviço para requerer a garantia.
			<bR>
			<bR>
          ...
          <div class="col-lg-6">
			...
			<br>
			<img src="assets/img/garantia.jpg" class="img-fluid rounded-4" alt="">
